...
<div id="products" class="album py-5 bg-light">
  ...
  <li class="nav-item">
    <a class="nav-link active" href="login.php">Logga in personal</a>
  </li>
  <li class="nav-item">
    <a class="nav-link" href="logincompany.php">Logga in företag</a>
  </li>
</ul>
  ...
  <h1 class="display-4">Logga in personal</h1>
  <p class="lead">Har du inget konto? Registrera <a href="register.php" >här</a></p>
        ...
        <form id="myForm" method="post" action="loginformular.php">
