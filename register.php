...
<div id="products" class="album py-5 bg-light">
  ...
  <li class="nav-item">
    <a class="nav-link active" href="register.php">Registrera personal</a>
  </li>
  <li class="nav-item">
    <a class="nav-link " href="registercompany.php">Registrera företag</a>
  </li>
</ul>
  ...
  <h1 class="display-4">Registrera personal</h1>
  <p class="lead">Har du redan ett konto? Logga in <a href="login.php" >här</a></p>
                        <small id="username" class="form-text text-muted">Dina uppgifter är alltid privata</small>
</div>
        
        
<form id="myForm" class="needs-validation" method="post" action="regform.php" novalidate onsubmit="return validateForm()">
    
    <div class="form-row">
            <div class="col-md-4 mb-3">
      <label for="validationCustomUsername">Företag</label>
  ...
  <path d="M2.5 11h1v1h-1v-1zm2 0h1v1h-1v-1zm-2 2h1v1h-1v-1zm2 0h1v1h-1v-1zm6-10h1v1h-1V3zm2 0h1v1h-1V3zm-4 2h1v1h-1V5zm2 0h1v1h-1V5zm2 0h1v1h-1V5zm-2 2h1v1h-1V7zm2 0h1v1h-1V7zm-4 0h1v1h-1V7zm0 2h1v1h-1V9zm2 0h1v1h-1V9zm2 0h1v1h-1V9zm-4 2h1v1h-1v-1zm2 0h1v1h-1v-1zm2 0h1v1h-1v-1z"/>
        ...
        <input type="text" class="form-control" id="foretag" name="foretag" aria-describedby="inputGroupPrepend" required>
  ...
  <div class="form-row">
    <div class="col-md-4 mb-3">
      ...
      <input type="text" class="form-control" id="fnamn" name="fnamn" required>
      <div class="valid-feedback">
        Ok!
      </div>
             <div class="invalid-feedback">
    ...
    <div class="col-md-4 mb-3">
      ...
      <label for="validationCustomUsername">Personnummer</label>
      <div class="input-group">
        <div class="input-group-prepend">
          <span class="input-group-text" id="inputGroupPrepend">10</span>
        </div>
        <input type="text" class="form-control" id="pnummer" name="pnummer" aria-describedby="inputGroupPrepend" maxlength="10" placeholder="ÅÅMMDDXXXX" required>
        
        <div class="invalid-feedback">
          Fyll i ditt Personnummer, 10 siffror exempel 9302105533
        </div>
           <div class="valid-feedback">
        Ok!
      </div>
