...
<body>
  ...
  <li class="nav-item">
    <a class="nav-link" href="scheduletable.php">Tabell</a>
  </li>
</ul>
...
.form-container .btn:hover, .open-button:hover {
  opacity: 1;
        ...
        <table align="center" border="0" class="header_tab">
            <tr>
                <th style="padding-right:50px;"><i class="fas fa-arrow-left mr-2"></i><a class="noBorder" href="calendar.php?timeStamp='.$prevTime.'">'.$prevMonthText.'</a></td>
                <th class="badge badge-secondary"><h4 class="m-2">'.$monthText . " - ".$yearText.'</h4></td>
                <th style="padding-left:50px;"><a class="noBorder" href="calendar.php?timeStamp='.$nextTime.'">'.$nextMonthText.'</a><i class="fas fa-arrow-right ml-2"></i></td>
            </tr>
        </table>
                ...
                if (isset($listWeek[$i])) {
                    ...
                    $month = $this->currentMonth;
                      $year = $this->currentYear;
                        $content = "<form method='get' id='myForm' action='insertSchema.php'><div class='text-center'>
